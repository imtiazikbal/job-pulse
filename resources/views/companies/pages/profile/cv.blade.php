...
@section('content')
    ...
    <head>
        ...
        <!-- FontAwesome JS-->
        <script defer src="{{ asset('cv') }}/assets/fontawesome/js/all.min.js"></script>

        <!-- Theme CSS -->
        <link id="theme-style" rel="stylesheet" href="{{ asset('cv') }}/assets/css/pillar-1.css">
                ...
                <header class="resume-header pt-4 pt-md-0">
                    <div class="row">
                        <div class="col-block col-md-auto resume-picture-holder text-center text-md-start">
                            <img class="picture" src="{{ asset('cv') }}/assets/images/profile.jpg" alt="">
                        </div><!--//col-->
                        <div class="col">
                                ...
                                <div class="primary-info col-auto">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="mb-2"><a class="text-link" href="#"><i
                                                    ...
                                                    data-fa-transform="grow-3"></i>{{ $details->email }}</a></li>
                                            ...
                                            <article class="resume-timeline-item position-relative pb-5">
                                                ...
                                                <div class="resume-timeline-item-desc">
                                                    <p>Role description goes here ipsum dolor sit amet, consectetuer
                                                        ...
                                                        pretium quis, sem. Donec pede justo, fringilla vel.</p>
                                                    ...
                                                    <ul>
                                                        <li>Lorem ipsum dolor sit amet, 80% consectetuer adipiscing elit.
                                                        </li>
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="mb-2">
                                            <div class="resume-degree font-weight-bold">
                                                {{ $details->education[0]->department }}</div>
                                            <div class="resume-degree-org">{{ $details->education[0]->university_name }}
                                            </div>
                                            <div class="resume-degree-time">{{ $details->education[0]->hons_passing_year }}
                                            </div>
                                        </li>
                                        <li>
                                            <div class="resume-degree font-weight-bold">
                                                {{ $details->education[0]->hsc_group }}</div>
                                            <div class="resume-degree-org">{{ $details->education[0]->hsc_college_name }}
                                            </div>
                                            <div class="resume-degree-time">{{ $details->education[0]->hsc_passing_year }}
                                            </div>
                                        </li>
                                    </ul>
                                </div>
