            ...
            <div class="row">
                        ...
                        <div class="single-listing">
                           <div class="small-section-tittle2">
                            ...
                            <div class="select-job-items2">
                                <select name="category" onchange="this.form.submit()" id="">
                            ...
                            <div class="select-Categories pt-80 pb-50">
                                ...
                                <label class="container">Full Time
                                    <input name="type[]" type="checkbox" value="Full Time" >
                                    <span class="checkmark"></span>
                                </label>
                                <label class="container">Part Time
                                    <input name="type[]" type="checkbox" value="Part Time">
                                    <span class="checkmark"></span>
                                </label>
                                ...
                                <label class="container">Freelance
                                    <input name="type[]" type="checkbox" value="Freelance">
                                    <span class="checkmark"></span>
                                </label>
                            ...
                            <div class="select-Categories pt-80 pb-50">
                                ...
                                <form action="{{ url('/jobs/filter/experience') }} " method="GET">
                                    <label class="container">1-2 Years
                                        <input type="checkbox" name="experience[]" value="1-2 Years">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="container">2-3 Years
                                        <input type="checkbox"  name="experience[]" value="2-3 Years" >
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="container">3-6 Years
                                        <input type="checkbox"  name="experience[]" value="3-6 Years" >
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="container">6-more..
                                        <input type="checkbox"  name="experience[]" value="6-more.." >
                                        <span class="checkmark"></span>
                                    </label>
                                <button class="btn mt-2 type="submit">Apply</button>
                ...
                <div class="single-job-items mb-30">
                    ...
                    <div class="items-link f-right">
                        <a href="{{ route('JobsDetails', ['job_id' => $job->id, 'company_id' => $job->user_id]) }}"> {{ $job->type }} </a>
